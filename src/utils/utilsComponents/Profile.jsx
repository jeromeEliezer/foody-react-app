...
import getStorage from '../utilsFuntions/utils_functions';
...
class Profile extends Component {
    ...
    submit_active = ()=> setTimeout(() => this.setState({ submit_button_display : "block"  }), 1000);
...
class DeletedItemsFromBookmarks extends Component{
